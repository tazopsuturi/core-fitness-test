...
public class LoginPage extends Form {
	...
	private final ILabel wrongCredentialsMsg = getElementFactory().getLabel(By.xpath("//div[@class='text-xs text-red-500']"), "Wrong Credentials");
	...
	public boolean isWrongCredentialsMsgDisplayed() {
		return wrongCredentialsMsg.state().waitForDisplayed();
	}
}
